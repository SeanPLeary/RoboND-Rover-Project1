...
class RoverState():
    def __init__(self):
        ...
        self.brake_set = 0.65 # Brake setting when braking
        # The stop_forward and go_forward fields below represent total count
        # of navigable terrain pixels.  This is a very crude form of knowing
        # when you can keep going and when you should stop.  Feel free to
        # get creative in adding new fields or modifying these!
        self.stop_forward = 205 # Threshold to initiate stopping
        self.go_forward = 1000 # Threshold to go forward again
        self.max_vel = 0.6 # Maximum velocity (meters/second)
        ...
        self.loop_counter3 = 0
        self.home_pos = None # Home position
        self.prev_pos = None # Rover's position during previous cycle
        self.obstacles_dists = None # Distances of obstacle pixels
        self.obstacles_angles = None # Distances of obstacle pixels
        self.prev_samples_found = 0 
